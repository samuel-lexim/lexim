...
if (isset($args) && $args) {
$bg = "";
if ($args["background"] && is_array($args["background"]) && isset($args["background"]["url"])) {
    $bg = $args["background"]["url"];
}
...
<div class="timeline_section one_col22" style="--bg-image: url(<?= $bg ?>);">
    <img class="imgBg" src="<?= $bg ?>" alt="" />
    <div class="_inner">
        <div class="leftCol">
